...
class LeafletMap extends Component {
    ...
    componentDidMount() {
        ...
        st1.on('click', () => {this.setState({device: "st1"}); this.props.handleMarker("st1"); });
        st2.on('click', () => {this.setState({device: "st2"}); this.props.handleMarker("st2"); });
        st3.on('click', () => {this.setState({device: "st3"}); this.props.handleMarker("st3"); });
        st4.on('click', () => {this.setState({device: "st4"}); this.props.handleMarker("st4"); });
        st5.on('click', () => {this.setState({device: "st5"}); this.props.handleMarker("st5"); });
